...
<html lang="es"><head>
    ...
    <body id="index" class="home">
        ...
        <header id="banner" class="body">
            <h1><a href="#">News Paper! <strong>HTML5 in the year <del>2022</del> <ins>2009</ins></strong></a></h1>
            <nav><ul>
        ...
        <footer id="contentinfo" class="body">
            <address id="about" class="vcard body">
                ...
                <img src="index_files/avatar.gif" alt="Smashing Magazine Logo" class="photo">
